///widget_button_2(view, x, y, text, font, color1, color2, steps, sprite, script);

// Creates a button object to execute code upon being clicked.
// NOTE: This script highlights the image index of the button. 1 is on, 0 is off.
...
// Dependencies: obj_button_2, input_check_type, input_check_pressed, animation_tween_step, tween_quintic_out
...
//Creates button.
var obj = instance_create(x1, x1, obj_button_2);
